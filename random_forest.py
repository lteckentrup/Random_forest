...
models = ['CanESM5', 'CESM2-WACCM','CMCC-CM2-SR5', 'EC-Earth3']

train_df = pd.DataFrame()

for m in models:
    fname = '../CMIP6/CTRL/'+m+'/temp_'+m+'_SSP245_r1i1p1f1_1850_2100_annual_australia_oz.nc'
    temp_CMIP6 = nc.Dataset(fname)
    train_df[m] = temp_CMIP6.variables['temp'][51:71,0,0]-273.15

fname_CRUJRA = '../reanalysis/CTRL/CRUJRA/temp_CRUJRA_1901-2018_annual_australia_oz.nc'
temp_CRUJRA = nc.Dataset(fname_CRUJRA)
train_df['CRUJRA'] = temp_CRUJRA.variables['temp'][:20,0,0]-273.15
